...
class Ui_RespiracionControlada(object):
    def setupUi(self, RespiracionControlada):
        ...
        #self.sldFrecRespiratoria.setTickPosition(QSlider.TicksBelow)
        self.sldFrecRespiratoria.setTickInterval(5)
        self.sldFrecRespiratoria.valueChanged.connect(self.sdlFrecRespiratoriaValueChanged)
    ...
    def sdlFrecRespiratoriaValueChanged(self):
